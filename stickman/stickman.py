...
class StickFigureSprite(Sprite):
    def __init__(self, game):
        Sprite.__init__(self, game)
        self.images_left = [
            tkinter.PhotoImage(file="stick-L1.gif"),
            tkinter.PhotoImage(file="stick-L2.gif"),
            tkinter.PhotoImage(file="stick-L3.gif")
        ]
        self.images_right = [
            tkinter.PhotoImage(file="stick-R1.gif"),
